...
Complete the findNextSquare function that finds the next integral perfect square after the one passed as a parameter. 
...
function findNextSquare(sq) {
    ...
    let decimal = squareRoot - Math.floor(squareRoot);
    return decimal === 0 ? (squareRoot + 1) ** 2 : -1;
}